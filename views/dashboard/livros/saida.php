...
<body>
    ...
    <main class="main">
        <div class="main-heading container">
            ...
            <span class="main-heading__breadcrumbs"><a class="breadcrumbs__link" href="<?=$basePath?>/livros/saida/<?=$livro['ID']?>">Registrar Saída</a> / <a class="breadcrumbs__link" href="<?=$basePath?>/livros/show/<?=$livro['ID']?>"><?=$livro['titulo']?></a> / <a class="breadcrumbs__link" href="<?=$basePath?>/livros">Livros</a> / <a class="breadcrumbs__link" href="<?=$basePath?>/dashboard">Dashboard</a></span>
        </div>
        ...
        <section class="section container">
            <div class="box">
                <div class="box-heading">
                    <h1 class="box-heading__title">Registrar Saída</h1>
                </div>
                <form class="form" action="<?=$basePath?>/livros/saida/<?=$livro['ID']?>" method="POST">
