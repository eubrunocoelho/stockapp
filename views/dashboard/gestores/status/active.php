...
<body>
    ...
    <main class="main">
        <div class="main-heading container">
            ...
            <span class="main-heading__breadcrumbs"><a class="breadcrumbs__link" href="<?=$basePath?>/gestores/status/active/<?=$gestorProfile['ID']?>">Ativar</a> / <a class="breadcrumbs__link" href="<?=$basePath?>/gestores/show/<?=$gestorProfile['ID']?>"><?=$gestorProfile['nome']?></a> / <a class="breadcrumbs__link" href="<?=$basePath?>/gestores">Gestores</a> / <a class="breadcrumbs__link" href="<?=$basePath?>/dashboard">Dashboard</a></span>
        </div>
        <section class="section container">
            <div class="box">
                ...
                <div class="operation-group mb--20">
                    <button class="btn bg--success" onclick="window.location.href='<?=$basePath?>/gestores/status/active/<?=$gestorProfile['ID']?>?confirm=active';">Ativar</button>
                </div>
            </div>
        </section>
    </main>
